...
public class SetLastSeen_MapResponse extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement outLocalEnv = newEnv.getRootElement();
			MbElement http = outLocalEnv.getFirstElementByPath("Destination/HTTP");

			http.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "ReplyStatusCode", "202");
